...
def _load_py_module(fname, pkg="lightning_galvatron"):
...
setup(
    name="lightning-galvatron",
    version=about.__version__,
    description=about.__docs__,
    author=about.__author__,
    author_email=about.__author_email__,
    url=about.__homepage__,
    download_url="https://github.com/Lightning-AI/lightning-galvatron",
    ...
    project_urls={
        "Bug Tracker": "https://github.com/Lightning-AI/lightning-galvatron/issues",
        "Documentation": "https://lightning-galvatron.rtfd.io/en/latest/",
        "Source Code": "https://github.com/Lightning-AI/lightning-galvatron",
    },
    classifiers=[
        "Environment :: Console",
